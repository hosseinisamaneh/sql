...
-- Filter for the most recent visit only.
...
-- Union the highest and lowest total sales dates.
...
SELECT 
    vendor_name, 
    product_name, 
    COUNT(customer_id) * product_price AS total_revenue
FROM CrossJoined
...
VALUES (101, 'Apple Pie', 'Medium', 'unit', 12.99, CURRENT_TIMESTAMP);
